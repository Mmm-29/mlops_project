...
from Networksecurity.utils.main_utils.util import save_object,load_object
from Networksecurity.utils.main_utils.util  import load_numpy_array_data,evaluate_models
...
class ModelTrainer:
    def __init__(self,model_trainer_config:ModelTrainerConfig,data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            logger.error("Error occurred during ModelTrainer initialization")  
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        # Track with mlflow test metrics and model
        logger.info("Logging train and test metrices with MLflow")
        ...
        save_object(self.model_trainer_config.trained_model_file_path,obj=Network_Model)
         #model pusher
        save_object("final_model/model.pkl",best_model)#saving the raw best model 
                                                       #(without the preprocessor wrapper) separately to final_model/model.pkl


        logger.info("Model saved successfully at: {}".format(self.model_trainer_config.trained_model_file_path))
